 ...
 * 
 @author Andrew Merrill, Spring 2004, last updated January 2013
 @version 1.3
...
public class SimpleFile extends File implements Iterable<String>
{
  ...
  static {
    try {
      BASEDIR = URLDecoder.decode(SimpleFile.class.getResource("SimpleFile.class").getPath().replaceAll("[^/]+$", ""), "UTF-8");
